...
| guc-0004c | Filter pipeline run (was “AI Pipeline”; promoted from a Shortlist sub-tab to its own page) | `ai_pipeline_page.html` | `GET /categories/{id}/ai-pipeline` | Active |
