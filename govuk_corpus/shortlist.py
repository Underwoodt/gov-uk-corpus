...
EXPORT_FIELDS = {
    ...
    "gds_stars": ("c.gds_stars", "GDS stars"),
    "source": ("c.source", "Source / provenance"),
    "last_seen_at": ("c.last_seen_at", "Last seen (crawl)"),
    "search_text": ("c.search_text", "Body text (search_text)"),
