...
_PROMPT_REVIEW_SYSTEM = (
    ...
    "## Suggested criteria\n"
    "Present the two criteria the team edits, each as its FULL reworded text ready to paste into that "
    ...
    "examples lists ONLY pages to keep, Drop examples ONLY pages to drop; never put a KEEP / DROP "
