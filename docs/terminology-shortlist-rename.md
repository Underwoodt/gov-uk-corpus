...
| The rules that define it          | definition / filters | **filters**                                   |                                                              |
| The pages it currently contains   | *the* shortlist      | **matching pages**                            | frees "shortlist" for the object                             |
...
| "run a category"                  | run                  | Retrieve the shortlist                        | .                                                            |
...
| Lede           | "A category is a saved set of rules for finding gov.uk pages about one topic. Choose a category to run it or change it, or create a new one." | "A shortlist is a saved set of filters that finds GOV.UK pages about one topic. Choose a shortlist to retrieve or change it, or build a new one." |
...
| Lede            | "A category is a saved set of rules for finding gov.uk pages…" | "A shortlist is a saved set of filters that finds GOV.UK pages about one topic. These filters build the shortlist, which you can then view." |
...
Change to reflect that his person is the owner fo the definitions, more who created it
